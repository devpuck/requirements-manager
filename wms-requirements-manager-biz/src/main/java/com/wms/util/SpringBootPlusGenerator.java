...
public class SpringBootPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 项目信息
        codeGenerator
                .setApiModuleName("wms-requirements-manager-api")
                .setBizModuleName("wms-requirements-manager-biz")
                .setTablePrefix("WMS_");


        // 组件作者等配置
        codeGenerator
                .setModuleName("requirements")
                .setAuthor("puck")
